...
def lambda_handler(event, context):
    ...
    def get_data(event):
        ...
        for i in records:
            ...
            data_record_map['login_date'] = to_athena_date_format(data['date'])
    ...
    def staging_injection(data_record_dict):
        ...
        records_filename = f"{ORIGIN_APP}-{APP_EVENT}-login-{string_date}.parquet"
        ...
        records_s3_obj_path = f"{EVENT_S3_STAGING_KEY}login/{records_filename}"
